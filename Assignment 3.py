...
print("Order {:>10s} Quantity {:>10s} Item Price {:>10s} Total {} ".format("", "", "", ""))#this adds the headings of the recepit
print("-" *75) #this creates the format of my recepit and the second line 
print(("{}").format(meals_price.get(order_data['MealNumber'], {}).get("Name")+ ("{:>10}").format(order_data["MealQuantity"])+ ("{:>20s}${:.2f}").format("", order_data.get('MealPrice')) + ("{:>13}${:.2f}").format("",total()))) #this prints the name, quantity, the price and the total
